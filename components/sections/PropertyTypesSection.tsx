...
const PROPERTY_TYPES = [
  {
    ...
    alt: "Villa avec piscine et pergola en bois, région de Casablanca",
  },
  {
    name: "Appartement",
    image: "/images/property-types/appartement.jpg",
    alt: "Séjour et salle à manger d'un appartement moderne à Casablanca",
  },
  {
    name: "Riad",
  ...
  },
  {
    ...
    alt: "Terrain vu du ciel dans un quartier résidentiel de Casablanca",
  },
  {
    name: "Commerce",
    image: "https://images.unsplash.com/photo-1759234119876-42e71955ae81?w=1200&q=80&auto=format&fit=crop",
    alt: "Étal artisanal coloré dans une médina marocaine, emplacement commercial typique",
  },
  {
    name: "Immeuble",
    image: "/images/property-types/immeuble.jpg",
    alt: "Toits de Casablanca et minaret au crépuscule, avec la Mosquée Hassan II en arrière-plan",
  },
];
